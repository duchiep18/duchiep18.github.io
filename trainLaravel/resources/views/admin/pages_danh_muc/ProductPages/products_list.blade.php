            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="">
                        <div class="row">
                            <div class="col-md-6">
                                    <input type="text" style="border=18" name="keywordsearch_products" value="{{ request()->input('keywordsearch') }}" class="form-control" id="" placeholder="Nhập sản phẩm muốn tìm kiếm"> <br> 
                            </div>
                            <div class="col-md-6">
