...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="/admin-frontend/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">
...
<body class="theme-red">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/cards/basic.html">Basic</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/cards/colored.html">Colored</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/cards/no-header.html">No Header</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/infobox/infobox-1.html">Infobox-1</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/infobox/infobox-2.html">Infobox-2</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/infobox/infobox-3.html">Infobox-3</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/infobox/infobox-4.html">Infobox-4</a>
                                    </li>
                                    <li>
                                        <a href="/admin-frontend/pages/widgets/infobox/infobox-5.html">Infobox-5</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="/admin-frontend/pages/ui/alerts.html">Alerts</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/animations.html">Animations</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/badges.html">Badges</a>
                            </li>

                            <li>
                                <a href="/admin-frontend/pages/ui/breadcrumbs.html">Breadcrumbs</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/buttons.html">Buttons</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/collapse.html">Collapse</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/colors.html">Colors</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/dialogs.html">Dialogs</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/icons.html">Icons</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/labels.html">Labels</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/list-group.html">List Group</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/media-object.html">Media Object</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/modals.html">Modals</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/pagination.html">Pagination</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/preloaders.html">Preloaders</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/progressbars.html">Progress Bars</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/range-sliders.html">Range Sliders</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/sortable-nestable.html">Sortable & Nestable</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/tabs.html">Tabs</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/thumbnails.html">Thumbnails</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/tooltips-popovers.html">Tooltips & Popovers</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/ui/waves.html">Waves</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="/admin-frontend/pages/tables/normal-tables.html">Normal Tables</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/tables/jquery-datatable.html">Jquery Datatables</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/tables/editable-table.html">Editable Tables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="/admin-frontend/pages/medias/image-gallery.html">Image Gallery</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/medias/carousel.html">Carousel</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="/admin-frontend/pages/maps/google.html">Google Map</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/maps/yandex.html">YandexMap</a>
                            </li>
                            <li>
                                <a href="/admin-frontend/pages/maps/jvectormap.html">jVectorMap</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <!-- Jquery Core Js -->
    <script src="/admin-frontend/plugins/jquery/jquery.min.js"></script>
