					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 056 812 4444</a></li>
								<li><a href="#"><i class="fa fa-phone"></i> 0965 455 594</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nguyenvietxue0809@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
