...
<html lang="en">
<head>
	<title>Máy bơm Bảo Long Admin Login</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form" action="{{ route('login.submit') }}" method="POST">
					@csrf
					<span class="login100-form-title p-b-49">
						Đăng nhập
					</span>
					
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Email là trường bắt buộc">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username là trường bắt buộc">
						...
						<input class="input100 " type="text" name="username" placeholder="Nhập vào username">
